...
function PageContent() {
  ...
  // 2. ຄົ້ນຫາ — validate → update URL → hook re-fetch
  const handleSearch = () => {
  ...
  // ── Empty state (ຍັງບໍ່ໄດ້ໃສ່ billNumber) ────────────────────────────────
  if (!data && !billNumber) {
    return (
      <div className="min-h-screen bg-slate-50 p-4 md:p-8">
        <div className="w-full max-w-7xl mx-auto space-y-6">
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 antialiased p-4 md:p-8 selection:bg-blue-100">
      <div className="mx-auto max-w-[90rem] space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-rose-100 bg-gradient-to-br from-white to-rose-50/10 p-5 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-emerald-100 bg-gradient-to-br from-white to-emerald-50/10 p-5 shadow-sm hover:shadow-md transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-slate-200/70 bg-white p-6 shadow-sm lg:col-span-2 space-y-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
              ...
              <Row label="ວັນທີສິ້ນສຸດງວດ" value={formatDate(data!.ENDDATE)} />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-1 bg-slate-800/40 p-4 rounded-xl border border-slate-800/60">
                ...
                <p className="text-sm text-slate-200 leading-relaxed break-all font-mono">
                  {data!.BANK_DESCRIPTION || "ບໍ່ມີລາຍລະອຽດ"}
                </p>
              </div>
            </div>
