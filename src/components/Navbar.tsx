...
import { Menu, ChevronRight, Home, LogOut, ChevronDown, Crown, Shield } from "lucide-react";
import ActivityLogButton from "@/components/ActivityLog";
...
export default function Navbar({ onMenuClick }: Props) {
  ...
  const handleLogout = async () => {
    setLoggingOut(true);
    try {
      if (user) logActivity({ uid: user.uid, displayName: user.displayName, email: user.email, action: "logout" });
